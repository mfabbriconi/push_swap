...
SRCS 	=	main.c utils/check_args.c utils/utils.c \
			...
			utils/ordering.c utils/maxmin.c utils/moves.c utils/moves2.c utils/moves3.c utils/moves4.c utils/sorting.c utils/sorting2.c utils/sorting3.c utils/calculate.c\
